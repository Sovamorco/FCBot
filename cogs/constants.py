...
answers = {
    ...
    'warnings': {
        ...
        'child': {
            ...
            'too_many_children': f'У ваших родителей уже есть {child_limit} {form(child_limit, ["ребенок", "ребенка", "детей"])}',
            'no_parents': 'У вас нет родителей!'
        },
        'not_your_child': 'Пользователь не ваш ребенок!',
        'too_many_children': f'У вас уже есть {child_limit} {form(child_limit, ["ребенок", "ребенка", "детей"])}',
